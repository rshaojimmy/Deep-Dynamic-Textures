...
output_dir =  '../../../testpic/motion/inter/train_nDi/';
if ~isdir(output_dir)
    mkdir(output_dir);
end
param.nata = 0.1;
...
for i_round = 1:roundNum
    ...
    [ W0, Wi ] = mtmultk( new_train_x, train_y, param );
    [ scores_test ] = test_multk( new_test_x,  W0, Wi );
...
if(issave)
    ...
    save(saveDataDir,'roc_x','roc_y','T','AUC','meanHTER_test', 'EER', 'W0_iter', 'Wi_iter' );
end
