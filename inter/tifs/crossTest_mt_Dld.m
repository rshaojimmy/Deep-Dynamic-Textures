...
% output_dir =  '../../../testpic/motion/inter/256_itr30_new/';
output_dir =  '/home/comp/ruishao/Documents/face_antispoofing/motion/results/inter/gabornew1/';
...
% load('/home/comp/ruishao/Documents/face_antispoofing/feat_result/3DMAD/Gabor/x_1.mat');
...
% load('/home/comp/ruishao/Documents/face_antispoofing/feat_result/sup/Gabor/x_1.mat');
...
if strcmp(crossProtcl, 'ours2D3MAD') %train on ours, test on 3DMAD
    ...
    load('../../../motion/chldis/ours2D3MAD_idx.mat');
    y_train = y_ours;
    x_train = x_ours;
    y_test = y_D3MAD;
    x_test = x_D3MAD;
    ...
    portion = 7;
        ...
        load('../../../motion/chldis/D3MAD2ours_idx_old.mat');
...
if(issave)
    ...
    save(saveDataDir,'roc_x','roc_y','T','AUC','meanHTER_test', 'stdHTER_test',...
