...
load('../../../results/intra/tifs/3Dd.mat');
...
varAllHTER_dvlp = var(meanHTER_dvlp);
varAllHTER_test = var(meanHTER_test);
...
save(saveDataDir,'roc_x','roc_y','T','AUC','EER','meanAllHTER_test','meanAllHTER_dvlp', 'varAllHTER_dvlp', ...
     'varAllHTER_test', 'meanHTER_dvlp','meanHTER_test');
