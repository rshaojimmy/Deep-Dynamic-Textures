...
% output_dir =  '../../../../testpic/motion/intra/3DMAD/labelold/ptnew/1/';
output_dir =  '/home/comp/ruishao/Documents/face_antispoofing/motion/results/intra/gabornew1/';

if ~isdir(output_dir)
    mkdir(output_dir);
end

saveFigDir = [output_dir, '3Df'];
saveDataDir = [output_dir, '3Dd'];
...
save(saveDataDir,'roc_x','roc_y','T','AUC','EER','meanAllHTER_test','meanAllHTER_dvlp', ...
    'stdAllHTER_dvlp', 'stdAllHTER_test', 'meanHTER_dvlp', 'meanHTER_test', ...
    'W0_iter_all', 'Wi_iter_all', 'D_iter_all','param');
