...
output_dir =  '/home/comp/ruishao/Documents/face_antispoofing/testpic/motion/intra/sup/labelold/ptnew/converge_new2/';

if ~isdir(output_dir)
    mkdir(output_dir);
end

saveDataDir = [output_dir, 'convgdat'];
...
for j_iter = 1 : testround
    for i_iter = 1:subjctNum 
        ...
        [allosevet, Dlosevet, W0lossvet, Wilossvet, Dvet, W0vet, Wivet] = mtmultk_convgnew( train_x, train_y, param );
                           
    end
end

save(saveDataDir,'allosevet', 'Dlosevet', 'W0lossvet', 'Wilossvet', 'Dvet', 'W0vet', 'Wivet');
