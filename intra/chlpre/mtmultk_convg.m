function [ allosevet, Dlosevet, W0lossvet, Wilossvet, Dvet, W0vet, Wivet] = mtmultk_convg( train_x, train_y, param )
...
%         end
        ...
        st2 = tic;
        Wi = Wical(V, W0, D, Y, param);
        Wiloss = Wiobjfun(  V, D, W0, Wi, Y, param );    
